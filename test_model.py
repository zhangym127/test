# coding= utf-8
from trainTest.read_data import read_name_list,read_file
from trainTest.train_model import Model
import cv2
import os 
import numpy as np
...
#     Label_list = np_utils.to_categorical(label_list, num_classes=counter)
    for img in img_list:
        ...
        if picType != -1:
            index += 1
            name_list = read_name_list('D:/workspace/trainTest/pictures/test')
            print(name_list)
...
if __name__ == '__main__':
    ...
    pro_predict=test_onBatch('D:/workspace/trainTest/pictures/test')
